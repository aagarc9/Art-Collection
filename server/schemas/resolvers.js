...
const resolvers = {
    ...
    Mutation: {
        ...
        // Related to Artwork
        addArtwork: async (parent, { title, image, description }, context) => {
            console.log('MUTATION addArtwork ran')
            if (context.user) {
                console.log(context.user)
                const artOwner = context.user.username
        ...
        removeArtwork: async (parent, { artId }, context) => {
            console.log('MUTATION removeArtwork ran')
            if (context.user) {
